...
function App() {
  ...
  const getPortfolioId = (projectName) => {
    const portfolioMap = {
      ...
      'Franchise': 4, 'GACA ILBZ Company Establishment Platform': 4, 'MC CR SBC Requirements': 4, 'NCFB': 4, 'ROSHN Marketplace': 4, 'SILZ': 4, 'Sijillaty': 4,
      ...
      'DigitalVentures': 12, 'DV AI MVP': 12, 'E-Delegation': 12, 'Tahaqaq': 12, 'Wathq': 12
    };
